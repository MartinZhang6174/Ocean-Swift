...
class Ocean_SwiftTests_05: XCTestCase {
    ...
    /*
    The submarine DELEGATES fishing duties to its captain. A Captain can either be normal or drunk. If the sub has a normal captain, the submarine catches the fish at that depth and tile, if the sub has a drunk captain, whenever the captain tries to catch a fish, he always comes up empty.
    */
